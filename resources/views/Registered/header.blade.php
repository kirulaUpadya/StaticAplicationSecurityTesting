<div class="top_nav">
  ...
  <nav class="nav">
    <div class="container nav_container">
      <img src="{{ asset('images/crown.png') }}" alt="" style="height: 4.5em; width: auto;" alt="Logo" />
      <a href="#" class="nav_logo" style="margin-left: -200px;" >EXCLUSIVE</a>
      <ul class="nav_list">
        <li class="nav_item">
      ...
      <div class="nav_items">
        <form action="{{ route('product.search') }}" method="GET" class="nav_form">
            <input
              type="text"
              name="name"
              class="nav_input"
              ...
              value="{{ request('name') }}"
            />
            <button type="submit" class="nav_search_btn" style="background: none; border: none; padding: 0;">
              <img src="{{ asset('images/search.png') }}" alt="Search" class="nav_search" style="cursor: pointer;" />
            </button>
          </form>
        ...
        <div class="nav_profile">
          ...
          <ul class="nav_profile_menu">
            ...
            <li>
              <a href="account.html"
                ><img
                  src="{{ asset('images/icon-mallbag.png') }}"
                  class="nav_profile_items_icon"
                />My Orders</a
              >
            </li>
            <li>
              <a href="account.html"
                ><img
                  src="{{ asset('images/icon-cancel.png') }}"
                  class="nav_profile_items_icon"
                />My Cancellations</a
              >
            </li>
            <li>
              <a href="account.html"
                ><img
                  src="{{ asset('images/Icon-Reviews.png') }}"
                  class="nav_profile_items_icon"
                />My Reviews</a
              >
            </li>
